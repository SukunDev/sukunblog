...
import useAllArticleAdmin from "@/hooks/admin/useAllArticleAdmin";
import PaginationsAdmin from "./paginationsAdmin";

export default function AllArticleAdmin({ data }) {
  const { handleDeleteButton, handlePagination } = useAllArticleAdmin();
            ...
            >
              ...
              <li>
                <button
                  ...
                  className="text-xs text-red-400 transition duration-300 hover:text-red-600"
                >
  ...
  return (
    <div className="my-8">
      ...
      />
      <PaginationsAdmin
        meta_paginator={data.meta_paginator}
